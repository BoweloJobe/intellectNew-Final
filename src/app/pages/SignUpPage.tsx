...
export function SignUpPage() {
  ...
  const handleSubmit = form.handleSubmit(async (values) => {
    ...
    const result = await run(
      ...
      {
        successMessage: "Account created successfully. Preparing your dashboard...",
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <GlassCard className="w-full max-w-md">
        <div className="text-center mb-10">
          <h1 className="text-3xl font-semibold mb-3 text-gray-900">Create Account</h1>
          <p className="text-gray-700">Start your learning journey with <span className="font-sans">intellectX</span></p>
        </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit} noValidate>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white/[0.45] text-gray-600">Or sign up with</span>
              </div>
            </div>
